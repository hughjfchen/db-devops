...
var args60950 = [];
var len__49364__auto___60953 = arguments.length;
var i__49365__auto___60954 = (0);
while(true){
if((i__49365__auto___60954 < len__49364__auto___60953)){
args60950.push((arguments[i__49365__auto___60954]));

var G__60955 = (i__49365__auto___60954 + (1));
i__49365__auto___60954 = G__60955;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args60950.length)].join('')));
...
var base_style__$1 = (cljs.core.truth_((function (){var and__48239__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__48239__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__48239__auto__)){
...
if(cljs.core.truth_((function (){var and__48239__auto__ = required_QMARK_;
if(cljs.core.truth_(and__48239__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__60960){
var map__60963 = p__60960;
var map__60963__$1 = ((((!((map__60963 == null)))?((((map__60963.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60963.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60963):map__60963);
var args = map__60963__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__60963__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__60963,map__60963__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__60957_SHARP_){
return item_renderer.call(null,p1__60957_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__60963,map__60963__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__60963,map__60963__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__60958_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__60958_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__60963,map__60963__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__60963,map__60963__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__60959_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__60959_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__60963,map__60963__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__49364__auto___60972 = arguments.length;
var i__49365__auto___60973 = (0);
while(true){
if((i__49365__auto___60973 < len__49364__auto___60972)){
args__49371__auto__.push((arguments[i__49365__auto___60973]));

var G__60974 = (i__49365__auto___60973 + (1));
i__49365__auto___60973 = G__60974;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__49372__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__60966){
var map__60967 = p__60966;
var map__60967__$1 = ((((!((map__60967 == null)))?((((map__60967.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__60967.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__60967):map__60967);
var args = map__60967__$1;
if(cljs.core.truth_(((cljs.core.not.call(null,goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__60967,map__60967__$1,args){
return (function() { 
var G__60975__delegate = function (p__60969){
...
var G__60975 = function (var_args){
var p__60969 = null;
if (arguments.length > 0) {
var G__60976__i = 0, G__60976__a = new Array(arguments.length -  0);
while (G__60976__i < G__60976__a.length) {G__60976__a[G__60976__i] = arguments[G__60976__i + 0]; ++G__60976__i;}
  p__60969 = new cljs.core.IndexedSeq(G__60976__a,0,null);
} 
return G__60975__delegate.call(this,p__60969);};
G__60975.cljs$lang$maxFixedArity = 0;
G__60975.cljs$lang$applyTo = (function (arglist__60977){
var p__60969 = cljs.core.seq(arglist__60977);
return G__60975__delegate(p__60969);
});
G__60975.cljs$core$IFn$_invoke$arity$variadic = G__60975__delegate;
return G__60975;
})()
;
;})(map__60967,map__60967__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq60965){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq60965));
});
