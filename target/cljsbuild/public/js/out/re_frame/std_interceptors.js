...
var vec__61424_61427 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_61428 = cljs.core.nth.call(null,vec__61424_61427,(0),null);
var only_after_61429 = cljs.core.nth.call(null,vec__61424_61427,(1),null);
var db_changed_QMARK__61430 = (!((only_before_61428 == null))) || (!((only_after_61429 == null)));
if(db_changed_QMARK__61430){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_61428);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_61429);
...
var map__61437 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__61437__$1 = ((((!((map__61437 == null)))?((((map__61437.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61437.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61437):map__61437);
var db = cljs.core.get.call(null,map__61437__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__61437__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__61445 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__61445__$1 = ((((!((map__61445 == null)))?((((map__61445.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__61445.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__61445):map__61445);
var coeffects = map__61445__$1;
var event = cljs.core.get.call(null,map__61445__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__49364__auto___61448 = arguments.length;
var i__49365__auto___61449 = (0);
while(true){
if((i__49365__auto___61449 < len__49364__auto___61448)){
args__49371__auto__.push((arguments[i__49365__auto___61449]));

var G__61450 = (i__49365__auto___61449 + (1));
i__49365__auto___61449 = G__61450;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__49372__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq61447){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq61447));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__48251__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__49371__auto__ = [];
var len__49364__auto___61456 = arguments.length;
var i__49365__auto___61457 = (0);
while(true){
if((i__49365__auto___61457 < len__49364__auto___61456)){
args__49371__auto__.push((arguments[i__49365__auto___61457]));

var G__61458 = (i__49365__auto___61457 + (1));
i__49365__auto___61457 = G__61458;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__49372__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__61451_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__61452_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__61452_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq61453){
var G__61454 = cljs.core.first.call(null,seq61453);
var seq61453__$1 = cljs.core.next.call(null,seq61453);
var G__61455 = cljs.core.first.call(null,seq61453__$1);
var seq61453__$2 = cljs.core.next.call(null,seq61453__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__61454,G__61455,seq61453__$2);
});
