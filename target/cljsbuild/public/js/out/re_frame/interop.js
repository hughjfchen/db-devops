...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__52380 = cljs.core.instance_QMARK_;
var expr__52381 = reactive_val;
if(cljs.core.truth_(pred__52380.call(null,reagent.ratom.RAtom,expr__52381))){
return "ra";
} else {
if(cljs.core.truth_(pred__52380.call(null,reagent.ratom.RCursor,expr__52381))){
return "rc";
} else {
if(cljs.core.truth_(pred__52380.call(null,reagent.ratom.Reaction,expr__52381))){
return "rx";
} else {
if(cljs.core.truth_(pred__52380.call(null,reagent.ratom.Track,expr__52381))){
return "tr";
} else {
return "other";
}
