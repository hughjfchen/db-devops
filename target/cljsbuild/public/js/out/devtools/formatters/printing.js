...
var len__49364__auto___51704 = arguments.length;
var i__49365__auto___51705 = (0);
while(true){
if((i__49365__auto___51705 < len__49364__auto___51704)){
args__49371__auto__.push((arguments[i__49365__auto___51705]));

var G__51706 = (i__49365__auto___51705 + (1));
i__49365__auto___51705 = G__51706;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__49372__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq51701){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__51702,G__51703,seq51701__$2);
});
...
if(cljs.core.truth_((function (){var or__48251__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__48862__auto__,writer__48863__auto__,opt__48864__auto__){
return cljs.core._write.call(null,writer__48863__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__48239__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__48239__auto__){
var or__48251__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__51707_SHARP_){
return !((cljs.core.meta.call(null,p1__51707_SHARP_) == null));
})))){
...
var map__51716 = opts;
var map__51716__$1 = ((((!((map__51716 == null)))?((((map__51716.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51716.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51716):map__51716);
var markup_db = cljs.core.get.call(null,map__51716__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__48251__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e51720){var _e__50585__auto__ = e51720;
return false;
}})();
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
...
}catch (e51722){var _e__50585__auto__ = e51722;
return false;
}}
})())){
...
var _STAR_current_state_STAR_51727 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__51728 = opts;
var map__51728__$1 = ((((!((map__51728 == null)))?((((map__51728.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__51728.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__51728):map__51728);
var markup_db = cljs.core.get.call(null,map__51728__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_51727;
}});
...
;
var temp__4655__auto___51733 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___51733)){
var managed_print_level_51734 = temp__4655__auto___51733;
var _STAR_print_level_STAR_51732_51735 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_51734;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_51732_51735,managed_print_level_51734,temp__4655__auto___51733,writer,opts,job_fn){
return (function (p1__51730_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__51730_SHARP_,null);
});})(_STAR_print_level_STAR_51732_51735,managed_print_level_51734,temp__4655__auto___51733,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_51732_51735;
}} else {
job_fn.call(null);
}
