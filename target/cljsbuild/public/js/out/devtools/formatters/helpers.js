...
var G__51661 = devtools.prefs.pref.call(null,v);
v = G__51661;
continue;
} else {
return v;
...
var and__48239__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__48239__auto__){
var and__48239__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__48251__auto__ = (function (){try{if(!((value == null))){
...
}catch (e51674){var _e__50585__auto__ = e51674;
return false;
}})();
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
var or__48251__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e51678){var _e__50585__auto__ = e51678;
return false;
}})();
...
}catch (e51680){var _e__50585__auto__ = e51680;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__48239__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__48239__auto__)){
var and__48239__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__48239__auto____$1){
...
var and__48239__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__48239__auto__)){
...
var or__48251__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
...
var and__48239__auto__ = (function (){var or__48251__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
...
var vec__51685 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__51685,(0),null);
var name = cljs.core.nth.call(null,vec__51685,(1),null);
...
var and__48239__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__48239__auto__)){
...
var or__48251__auto__ = typeof value === 'string';
if(or__48251__auto__){
return or__48251__auto__;
} else {
var or__48251__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__51688_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__51688_SHARP_);
}),template);
});
