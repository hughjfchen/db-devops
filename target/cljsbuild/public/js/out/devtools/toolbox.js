...
var args61049 = [];
var len__49364__auto___61055 = arguments.length;
var i__49365__auto___61056 = (0);
while(true){
if((i__49365__auto___61056 < len__49364__auto___61055)){
args61049.push((arguments[i__49365__auto___61056]));

var G__61057 = (i__49365__auto___61056 + (1));
i__49365__auto___61056 = G__61057;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args61049.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox61052 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox61052 = (function (obj,header,style,tag,meta61053){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox61052.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61054,meta61053__$1){
var self__ = this;
var _61054__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox61052(self__.obj,self__.header,self__.style,self__.tag,meta61053__$1));
});

devtools.toolbox.t_devtools$toolbox61052.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61054){
var self__ = this;
var _61054__$1 = this;
return self__.meta61053;
});

devtools.toolbox.t_devtools$toolbox61052.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox61052.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox61052.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox61052.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox61052.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta61053","meta61053",-1310324164,null)], null);
});

devtools.toolbox.t_devtools$toolbox61052.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox61052.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox61052";

devtools.toolbox.t_devtools$toolbox61052.cljs$lang$ctorPrWriter = (function (this__48862__auto__,writer__48863__auto__,opt__48864__auto__){
return cljs.core._write.call(null,writer__48863__auto__,"devtools.toolbox/t_devtools$toolbox61052");
});

devtools.toolbox.__GT_t_devtools$toolbox61052 = (function devtools$toolbox$__GT_t_devtools$toolbox61052(obj__$1,header__$1,style__$1,tag__$1,meta61053){
return (new devtools.toolbox.t_devtools$toolbox61052(obj__$1,header__$1,style__$1,tag__$1,meta61053));
});

}

return (new devtools.toolbox.t_devtools$toolbox61052(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
