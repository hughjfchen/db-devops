...
var o51508 = temp__4655__auto__;
var temp__4655__auto____$1 = (o51508["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o51509 = temp__4655__auto____$1;
return (o51509["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__50578__auto__ = f;
return (o__50578__auto__["toString"]).call(o__50578__auto__);
} else {
return "";
}
}catch (e51511){var _ = e51511;
return "";
}});
...
try{var o__50578__auto___51514 = t;
(o__50578__auto___51514["cljs$lang$ctorPrWriter"]).call(o__50578__auto___51514,t,writer);
}catch (e51513){var __51515 = e51513;
}
...
var char_code = (function (){var o__50578__auto__ = (new String(char$));
return (o__50578__auto__["charCodeAt"]).call(o__50578__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__50578__auto__ = String;
return (o__50578__auto__["fromCharCode"]).call(o__50578__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__51517 = num_code;
switch (G__51517) {
case (1):
return (185);
...
var o__50578__auto__ = String;
return (o__50578__auto__["fromCharCode"]).call(o__50578__auto__,superscript_code);
});
/**
...
}catch (e51523){var _e__50585__auto__ = e51523;
return false;
}})())){
...
var vec__51524 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__51524,(0),null);
...
var or__48251__auto__ = (function (){var temp__4655__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__4655__auto__)){
...
if(cljs.core.truth_(temp__4655__auto__)){
var o51529 = temp__4655__auto__;
var temp__4655__auto____$1 = (o51529["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o51530 = temp__4655__auto____$1;
return (o51530["nameToPath"]);
} else {
return null;
}
} else {
...
var len__49364__auto___51537 = arguments.length;
var i__49365__auto___51538 = (0);
while(true){
if((i__49365__auto___51538 < len__49364__auto___51537)){
args__49371__auto__.push((arguments[i__49365__auto___51538]));

var G__51539 = (i__49365__auto___51538 + (1));
i__49365__auto___51538 = G__51539;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__49372__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__51533){
var vec__51534 = p__51533;
var ns_detector = cljs.core.nth.call(null,vec__51534,(0),null);
var effective_detector = (function (){var or__48251__auto__ = ns_detector;
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
...
var G__51540 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__51541 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__51540;
remaining_tokens = G__51541;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq51531){
var G__51532 = cljs.core.first.call(null,seq51531);
var seq51531__$1 = cljs.core.next.call(null,seq51531);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__51532,seq51531__$1);
});
...
var vec__51549 = cljs.core.split_with.call(null,(function (p1__51545_SHARP_){
return cljs.core.not_EQ_.call(null,p1__51545_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__51549,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__51549,(1),null);
...
var vec__51555 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__51555,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__51555,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__51558 = cljs.core.rest.call(null,remaining_tokens);
var G__51559 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__51558;
name_tokens = G__51559;
continue;
} else {
...
var args51560 = [];
var len__49364__auto___51572 = arguments.length;
var i__49365__auto___51573 = (0);
while(true){
if((i__49365__auto___51573 < len__49364__auto___51572)){
args51560.push((arguments[i__49365__auto___51573]));

var G__51574 = (i__49365__auto___51573 + (1));
i__49365__auto___51573 = G__51574;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args51560.length)].join('')));
...
var vec__51563 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__51563,(0),null);
var arity = cljs.core.nth.call(null,vec__51563,(1),null);
var vec__51566 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__51566,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__51566,(1),null);
var vec__51569 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__51569,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__51569,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__51569,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__51569,(3),null);
...
var args51576 = [];
var len__49364__auto___51582 = arguments.length;
var i__49365__auto___51583 = (0);
while(true){
if((i__49365__auto___51583 < len__49364__auto___51582)){
args51576.push((arguments[i__49365__auto___51583]));

var G__51584 = (i__49365__auto___51583 + (1));
i__49365__auto___51583 = G__51584;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args51576.length)].join('')));
...
var vec__51579 = result;
var munged_ns = cljs.core.nth.call(null,vec__51579,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__51579,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__51579,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__51579,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__51579,(4),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__51592 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__51592,(0),null);
var args = cljs.core.nth.call(null,vec__51592,(1),null);
var vec__51595 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__51595,(0),null);
var name = cljs.core.nth.call(null,vec__51595,(1),null);
...
var G__51598 = (arity + (1));
var G__51599 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__51600){
var vec__51604 = p__51600;
var arity = cljs.core.nth.call(null,vec__51604,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__51604,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__48251__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__51607_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__51608_SHARP_);
...
var args__49371__auto__ = [];
var len__49364__auto___51615 = arguments.length;
var i__49365__auto___51616 = (0);
while(true){
if((i__49365__auto___51616 < len__49364__auto___51615)){
args__49371__auto__.push((arguments[i__49365__auto___51616]));

var G__51617 = (i__49365__auto___51616 + (1));
i__49365__auto___51616 = G__51617;
continue;
} else {
}
break;
...
var argseq__49372__auto__ = ((((1) < args__49371__auto__.length))?(new cljs.core.IndexedSeq(args__49371__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__49372__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__51611){
var vec__51612 = p__51611;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__51612,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq51609){
var G__51610 = cljs.core.first.call(null,seq51609);
var seq51609__$1 = cljs.core.next.call(null,seq51609);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__51610,seq51609__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__48251__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__48239__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__48251__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__51626__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__51626__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__51626__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__51626__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__51627 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__51627,(0),null);
var fn_name = cljs.core.nth.call(null,vec__51627,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__51627,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__51627,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__51627,(4),null);
var arity = cljs.core.nth.call(null,vec__51627,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__48239__auto__ = protocol_ns;
if(cljs.core.truth_(and__48239__auto__)){
return cljs.core.not.call(null,(function (){var and__48239__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__48251__auto__ = protocol_part;
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
return fn_part;
...
var o__50578__auto__ = f;
return (o__50578__auto__["getBasis"]).call(o__50578__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__48239__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__48239__auto__)){
...
}catch (e51632){var _e__50585__auto__ = e51632;
...
var G__51633 = (obj[cljs.core.first.call(null,path)]);
var G__51634 = cljs.core.rest.call(null,path);
obj = G__51633;
path = G__51634;
continue;
} else {
...
var partition_bits = (function (){var or__48251__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
return (0);
...
return (function (accum,p__51639){
var vec__51640 = p__51639;
var bit = cljs.core.nth.call(null,vec__51640,(0),null);
var protocol = cljs.core.nth.call(null,vec__51640,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__51643){
var vec__51647 = p__51643;
var ns = cljs.core.nth.call(null,vec__51647,(0),null);
var name = cljs.core.nth.call(null,vec__51647,(1),null);
var selector = cljs.core.nth.call(null,vec__51647,(2),null);
...
return (function (p__51655){
var vec__51656 = p__51655;
var munged_name = cljs.core.nth.call(null,vec__51656,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__51656,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__51656,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__51650_SHARP_){
return (obj[cljs.core.first.call(null,p1__51650_SHARP_)]);
});})(name,sorted_matches,vec__51656,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
