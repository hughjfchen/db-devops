...
var reader = (function (){var or__48251__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__48251__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__48251__auto__)){
return or__48251__auto__;
} else {
return (128);
...
var map__55497 = top_item;
var map__55497__$1 = ((((!((map__55497 == null)))?((((map__55497.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55497.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__55497):map__55497);
var file = cljs.core.get.call(null,map__55497__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__55497__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__55497__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e55496){var _e = e55496;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___55499 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___55499)){
var seen_errors_55500 = temp__4655__auto___55499;
if(cljs.core.truth_(seen_errors_55500.has(self))){
} else {
seen_errors_55500.add(self);

var temp__4657__auto___55501 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___55501)){
var sense_55502 = temp__4657__auto___55501;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),cljs.core.str.cljs$core$IFn$_invoke$arity$1(", a sanity hint:\n"),cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_55502)].join('');
} else {
}
}
} else {
