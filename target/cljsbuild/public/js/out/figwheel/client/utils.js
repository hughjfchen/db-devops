...
var or__48251__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj51285 = {"detail":data};
return obj51285;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__48239__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__48239__auto__)){
var and__48239__auto____$1 = (window["CustomEvent"]);
...
var args51290 = [];
var len__49364__auto___51296 = arguments.length;
var i__49365__auto___51297 = (0);
while(true){
if((i__49365__auto___51297 < len__49364__auto___51296)){
args51290.push((arguments[i__49365__auto___51297]));

var G__51298 = (i__49365__auto___51297 + (1));
i__49365__auto___51297 = G__51298;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args51290.length)].join('')));
...
var f = (function (){var pred__51293 = cljs.core._EQ_;
var expr__51294 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__51293.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__51294))){
return ((function (pred__51293,expr__51294){
return (function (p1__51286_SHARP_){
return console.warn(p1__51286_SHARP_);
});
;})(pred__51293,expr__51294))
} else {
if(cljs.core.truth_(pred__51293.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__51294))){
return ((function (pred__51293,expr__51294){
return (function (p1__51287_SHARP_){
return console.debug(p1__51287_SHARP_);
});
;})(pred__51293,expr__51294))
} else {
if(cljs.core.truth_(pred__51293.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__51294))){
return ((function (pred__51293,expr__51294){
return (function (p1__51288_SHARP_){
return console.error(p1__51288_SHARP_);
});
;})(pred__51293,expr__51294))
} else {
return ((function (pred__51293,expr__51294){
return (function (p1__51289_SHARP_){
return console.log(p1__51289_SHARP_);
});
;})(pred__51293,expr__51294))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__51300){
var map__51303 = p__51300;
...
var opts = map__51303__$1;
var eval_fn = cljs.core.get.call(null,map__51303__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__51305_SHARP_);
});})(new_def))
);
...
return (function (p__51306){
var vec__51307 = p__51306;
var ky = cljs.core.nth.call(null,vec__51307,(0),null);
var v = cljs.core.nth.call(null,vec__51307,(1),null);
...
var args51310 = [];
var len__49364__auto___51313 = arguments.length;
var i__49365__auto___51314 = (0);
while(true){
if((i__49365__auto___51314 < len__49364__auto___51313)){
args51310.push((arguments[i__49365__auto___51314]));

var G__51315 = (i__49365__auto___51314 + (1));
i__49365__auto___51314 = G__51315;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args51310.length)].join('')));
...
if(cljs.core.truth_((function (){var and__48239__auto__ = typeof localStorage !== 'undefined';
