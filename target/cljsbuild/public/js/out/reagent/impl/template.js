...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__48862__auto__,writer__48863__auto__,opt__48864__auto__){
return cljs.core._write.call(null,writer__48863__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__52191 = o;
(G__52191[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__48239__auto__ = !((jsprops == null));
if(and__48239__auto__){
var and__48239__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__52199 = jsprops;
(G__52199["defaultValue"] = value);

(G__52199["onChange"] = ((function (G__52199,v,value,on_change){
return (function (p1__52197_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__52197_SHARP_);
});})(G__52199,v,value,on_change))
);
...
var vec__52206 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__52206,(0),null);
var id = cljs.core.nth.call(null,vec__52206,(1),null);
var class$ = cljs.core.nth.call(null,vec__52206,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___52211 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___52211 == null)){
} else {
var key_52212 = temp__4661__auto___52211;
...
var G__52214 = (new reagent.impl.template.NativeWrapper());
(G__52214["name"] = c);
...
var len__49364__auto___52220 = arguments.length;
var i__49365__auto___52221 = (0);
while(true){
if((i__49365__auto___52221 < len__49364__auto___52220)){
args__49371__auto__.push((arguments[i__49365__auto___52221]));

var G__52222 = (i__49365__auto___52221 + (1));
i__49365__auto___52221 = G__52222;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__49372__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq52218){
var G__52219 = cljs.core.first.call(null,seq52218);
var seq52218__$1 = cljs.core.next.call(null,seq52218);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__52219,seq52218__$1);
});
...
break;
default:
var G__52226 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__52226;
continue;
...
var n__49174__auto___52229 = a.length;
var i_52230 = (0);
while(true){
if((i_52230 < n__49174__auto___52229)){
(a[i_52230] = reagent.impl.template.as_element.call(null,(a[i_52230])));

var G__52231 = (i_52230 + (1));
i_52230 = G__52231;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__49174__auto___52232 = a.length;
var i_52233 = (0);
while(true){
if((i_52233 < n__49174__auto___52232)){
var val_52234 = (a[i_52233]);
if((cljs.core.vector_QMARK_.call(null,val_52234)) && ((reagent.impl.template.key_from_vec.call(null,val_52234) == null))){
(o["no-key"] = true);
} else {
}

(a[i_52233] = reagent.impl.template.as_element.call(null,val_52234));

var G__52235 = (i_52233 + (1));
i_52233 = G__52235;
continue;
} else {
}
...
var ctx = ({});
var vec__52239 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__52239,(0),null);
var derefed = cljs.core.nth.call(null,vec__52239,(1),null);
...
var G__52243 = (cljs.core.count.call(null,argv) - first_child);
switch (G__52243) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__52243){
